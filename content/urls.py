...
urlpatterns = [
                  ...
                  url(r'^meetOurTeam/$', TemplateView.as_view(template_name='meet_our_team.html'),name='team'),
                  url(r'^upvote/$', views.Upvote),
                  url(r'^upvote_blog/$', views.Upvote_Blog),
                  url(r'^show_full_blog/(?P<blog_id>\w+)', views.show_full_blog,name='blogs'),
                  ...
                  url(r'^report/(?P<post_id>\w+)', views.report_post),
                  url('all_blogs/', views.All_Blogs, name='All_Blogs'),
                  ...
                  url('approvebook/(?P<bookid>\w+)', views.Approve_Book, name='Approve_Book'),
                  url('deletenote/(?P<noteid>\w+)', views.Delete_Note, name='Delete_Note'),
                  url('deletepaper/(?P<paperid>\w+)', views.Delete_Paper, name='Delete_Paper'),
                  url('deletebook/(?P<bookid>\w+)', views.Delete_Book, name='Delete_Book'),
                  ...
                  url(r'^view_book_pdf/(?P<bookid>\w+)', views.Display_Book_Pdf, name='Display_Book_Pdf'),
                  url(r'^course_notes/(?P<slug>[-\w]+)/$', views.Show_Note, name='Course_Note'),
